...
export const Faq = () => {
  ...
  return (
    <section className="my-10 p-7 border rounded dark:border-slate-700 shadow-sm">
        ...
        <div className="" id="accordion-flush" data-accoudian="collapse" data-active-classes="bg-white dark:bg-gray-900 text-gray-900 dark:text-white" 
        data-inactive-classes="text-gray-500 dark:text-gray-400">
            {faqs.map((faqs) => (
                <Accordion key={faqs.id} faq = {faqs}/>
            ))}
